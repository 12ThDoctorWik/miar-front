      ...
      <a className="gameCard" href="#!">
        ...
        >
          ...
          <div className="gameCard__overlay">
            ...
            <div className="gameCard__data">
              <div className="gameCard__line"><img src={master} alt="master"/> <span>{info.MasterName}</span></div>
              <div className="gameCard__line"><img src={date} alt="date"/> <span>{info.StartTime}</span></div>
              <div className="gameCard__line"><img src={location} alt="location"/> <span>{info.Location}</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="back">
          <div className="back__info">
            ...
            <div className="back__text">
              Рівні: <span className="back__data">{info.MinLevel} {" - "} {info.MaxLevel}</span>{" "}
            </div>
            <div className="back__text">
              Доступні місця:{" "}
              <span className="back__data">{info.MaxPlayer - info.CurrentPlayers}</span>{" "}
            </div>
            <div className="back__text">
              Ціна: <span className="back__data">{info.PricePerPlayer} грн</span>
            </div>
            <div className="back__text">
              Тип партії:{" "}
              <span className="back__data">Ofline</span>{" "}
            </div>
          </div>
