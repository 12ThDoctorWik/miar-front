  ...
  return (
    <div className="materials container mainPage__block">
      ...
      <div className="materials__text">
        ...
        приклади і поради.
        <br /> <br />
        Існують також відеоуроки на YouTube від досвідчених гравців і
        гейм-мастерів, які детально пояснюють правила і стратегії гри. Багато
        ігрових платформ, таких як Roll20 або Fantasy Grounds, пропонують
        ...
        гри.
        <br /> <br />
        Нарешті, офіційний вебсайт D&D має багато безкоштовних матеріалів, які
        допоможуть розпочати пригоду в цьому захоплюючому світі настільних
        рольових ігор.
      </div>
